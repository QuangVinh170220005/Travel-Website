...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Kalam:wght@300;400;700&family=Roboto:wght@300;400;500;700&display=swap"
        rel="stylesheet">
...
<body class="font-sans min-h-screen bg-gray-100">
    ...
    <script>
        function loadContent(element) {
            if (element.classList.contains('form-navigation') || element.hasAttribute('data-no-ajax')) {
