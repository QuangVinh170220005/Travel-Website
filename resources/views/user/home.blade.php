...
<div class="relative">
        ...
        <div class="container mx-auto h-full relative z-10">
            <div class="flex items-center justify-center h-full">
                <div class="text-center text-white">
                    ...
                    <!-- Thay thế phần form cũ trong hero banner -->
                    <div
                        class="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto transition-all duration-300 hover:shadow-2xl">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="relative col-span-4 md:col-span-2">
                                ...
                                <div id="searchResults"
                                    class="absolute left-0 right-0 mt-2 bg-white rounded-md shadow-lg hidden z-50 max-h-96 overflow-y-auto">
                            ...
                            <button id="searchButton"
                                class="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-all duration-300 transform hover:scale-105">
                                Tìm kiếm
                            </button>
                        </div>
                    </div>
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
                <h1
                    class="text-4xl font-bold text-center md:text-left transition-all duration-300 hover:text-5xl hover:text-blue-600">
                    Popular Tours</h1>

                <div
                    class="flex items-center bg-white rounded-full border shadow-sm w-full md:w-auto transition-all duration-300 hover:shadow-lg">
                    <input type="text" placeholder="SEARCH YOUR NEXT CITY"
                        class="px-6 py-3 rounded-l-full outline-none text-gray-600 w-full md:w-80 transition-all duration-300 focus:ring-2 focus:ring-blue-500">
                    <button
                        class="bg-slate-900 text-white px-8 py-3 rounded-full hover:bg-slate-800 whitespace-nowrap transition-all duration-300 transform hover:scale-105">Search</button>
                </div>
            </div>
            ...
            <div class="flex flex-wrap gap-4 mt-8 justify-center">
                <button
                    class="px-6 py-2 rounded-full bg-teal-500 text-white transition-all duration-300 hover:bg-teal-600 transform hover:scale-110">All</button>
                @foreach(['London', 'Spain', 'Nottingham', 'Leicester', 'Plymouth', 'Derby', 'Southampton', 'Manchester', 'Liverpool'] as $city)
                    <button
                        class="px-6 py-2 rounded-full bg-white border hover:bg-gray-50 transition-all duration-300 hover:border-blue-500 transform hover:scale-110">{{ $city }}</button>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex overflow-x-auto gap-6 pb-6">
            @foreach($popularTours as $tour)
                <div
                    class="flex-none w-[300px] bg-white rounded-lg overflow-hidden shadow hover:shadow-lg transition-all duration-300">
                    <div class="h-48 w-full relative overflow-hidden">
                        <!-- Nút yêu thích -->
                        <button
                            class="absolute top-4 right-4 z-10 p-2 bg-white bg-opacity-70 rounded-full hover:bg-opacity-100 transition-all duration-300 group">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-2">
                            <!-- Tour details -->
                            @foreach([['icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'text' => $tour->duration_days . ' ngày ' . ($tour->duration_nights ?? ($tour->duration_days - 1)) . ' đêm'], ['icon' => 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064', 'text' => $tour->max_participants . ' người'], ['icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', 'text' => '7 Mar - Nov 2024'], ['icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'text' => 'Book by 30 October 2024']] as $item)
    ...
    <section class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            <h2
                class="text-3xl font-bold text-center mb-10 transition-all duration-300 hover:text-4xl hover:text-blue-600">
                Special Offers</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                @foreach(['Early Bird Discount', 'Family Package'] as $index => $offer)
                    <div
                        class="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:scale-105">
                        <div class="flex flex-col md:flex-row">
                            <div class="md:w-1/3 overflow-hidden">
                                <img src="{{ asset('https://i.pinimg.com/736x/70/35/00/703500d5da9cf9eb3d60e39844da7e5e.jpg') }}"
                                    class="w-full h-full object-cover transition-all duration-500 transform hover:scale-110"
                                    alt="Offer">
                            </div>
                            <div class="md:w-2/3 p-6">
                                <h5 class="text-xl font-semibold mb-2 transition-all duration-300 hover:text-blue-600">
                                    {{ $offer }}
                                </h5>
                                ...
                                <a href="#"
                                    class="inline-block bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-all duration-300 transform hover:scale-105">Book
                                    Now</a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-9 relative">
            ...
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                <a href="{{ route('blog') }}"
                    class="bg-blue-400 hover:bg-blue-500 text-white font-bold py-3 px-6 transition duration-300 shadow-lg rounded-full">
                    Read All Blog
                </a>
            </div>
            ...
            <div class="relative overflow-hidden group" style="border-radius: 7% 8% 19% 5% / 9% 8% 20% 10%">
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-b from-transparent to-black/70 p-6 flex flex-col justify-end">
                    <h3 class="text-white text-2xl font-bold mb-2">Experience the iconic Times Square ball drop or a
                        scenic river cruise.</h3>
                    <p class="text-gray-200 text-sm">
                        Europe, with its rich history, stunning landscapes, and vibrant culture, is a continent brimming
                        with iconic attractions.
                    </p>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden group" style="border-radius: 8% 5% 7% 19% / 8% 10% 9% 20%">
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-b from-transparent to-black/70 p-6 flex flex-col justify-end">
                    <h3 class="text-white text-2xl font-bold mb-2">Revel in riverside festivities and rooftop views of
                        the fireworks.</h3>
                    <p class="text-gray-200 text-sm">
                        Europe, with its rich history, stunning landscapes, and vibrant culture, is a continent brimming
                        with iconic attractions.
            ...
            <div class="relative overflow-hidden group" style="border-radius: 5% 19% 8% 7% / 10% 20% 8% 9%">
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-b from-transparent to-black/70 p-6 flex flex-col justify-end">
                    <h3 class="text-white text-2xl font-bold mb-2">Marvel at extravagant displays near Burj Khalifa and
                        enjoy.</h3>
                    <p class="text-gray-200 text-sm">
                        Europe, with its rich history, stunning landscapes, and vibrant culture, is a continent brimming
                        with iconic attractions.
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 container mx-auto">
        ...
        <div class="bg-gray-50 rounded-lg p-6 md:p-8">
            <blockquote class="text-gray-700 text-lg md:text-xl mb-6">
                "I have been a proud member of this incredible gym for over a year now, and the experience has been
                nothing short of amazing. The state-of-the-art equipment, knowledgeable staff, and diverse group classes
                have made my fitness journey not only effective but truly enjoyable"
            </blockquote>
...
<section class="py-16">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-10 transition-all duration-300 hover:text-4xl hover:text-blue-600">
            Why Choose Us</h2>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            @foreach([['icon' => 'fa-shield-alt', 'title' => 'Secure Booking', 'description' => '100% secure payment system'], ['icon' => 'fa-dollar-sign', 'title' => 'Best Price', 'description' => 'Guaranteed best prices'], ['icon' => 'fa-headset', 'title' => '24/7 Support', 'description' => 'Dedicated support team'], ['icon' => 'fa-heart', 'title' => 'Travel Insurance', 'description' => 'Comprehensive coverage']] as $feature)
                <div class="text-center transition-all duration-300 transform hover:scale-105">
                    <div class="mb-4">
                        <i
                            class="fas {{ $feature['icon'] }} text-4xl text-blue-600 transition-all duration-300 hover:text-blue-700"></i>
                    </div>
                    <h4 class="text-xl font-semibold mb-2 transition-all duration-300 hover:text-blue-600">
                        {{ $feature['title'] }}
                    </h4>
                    <p class="text-gray-600 transition-all duration-300 hover:text-gray-700">{{ $feature['description'] }}
                    </p>
                </div>
            @endforeach
        </div>
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center p-4 sm:p-6 lg:p-8">
            <div class="max-w-5xl mx-auto w-full">
                ...
                <p class="text-sm sm:text-base lg:text-lg text-gray-600 mb-6 sm:mb-8 max-w-3xl mx-auto px-4">
                    We'll send our latest travel offers and exclusive packages straight to your inbox by signing up to
                    this newsletter,
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full max-w-2xl mx-auto px-4">
                    <input type="email" placeholder="Enter Your Email address" class="flex-1 px-4 sm:px-6 py-3 sm:py-4 rounded-full border-2 border-gray-200 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function displayResults(results) {
            if (results.length === 0) {
                searchResults.innerHTML = '<div class="px-4 py-2 text-gray-500">Không tìm thấy kết quả</div>';
            } else {
                searchResults.innerHTML = results.map(tour => `
                <div class="tour-result p-4 hover:bg-gray-50 cursor-pointer border-b last:border-b-0">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 w-16 h-16">
                            <img src="${tour.main_image?.image_path ? '/storage/' + tour.main_image.image_path : '/images/default.jpg'}" 
                                 class="w-full h-full object-cover rounded" 
                                 alt="${tour.tour_name}">
                        </div>
                        <div class="ml-4 flex-grow">
                            <h4 class="font-semibold text-gray-800">${tour.tour_name}</h4>
                            <p class="text-sm text-gray-600">${tour.duration_days} ngày</p>
                            <p class="text-sm font-semibold text-green-600">
                                ${tour.price_lists?.[0]?.price_details?.[0]?.price
                        ? '$' + Number(tour.price_lists[0].price_details[0].price).toLocaleString()
                        : 'Liên hệ'}
                            </p>
                        </div>
                    </div>
        ...
        // Xử lý click bên ngoài để ẩn kết quả
        ...
        searchResults.addEventListener('click', function (e) {
            const tourResult = e.target.closest('.tour-result');
            if (tourResult) {
                const index = Array.from(searchResults.children).indexOf(tourResult);
                const selectedTour = currentSearchResults[index];
                searchInput.value = selectedTour.tour_name;
                selectedTourId = selectedTour.tour_id;
                searchResults.classList.add('hidden');
            }
        });
        ...
        searchButton.addEventListener('click', function () {
            ...
            if (query) {
                // Sử dụng route name 'explore' thay vì URL trực tiếp
                window.location.href = `{{ route('explore') }}?search=${encodeURIComponent(query)}`;
            }
        });
