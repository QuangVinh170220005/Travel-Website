...
$latestPosts = [
    ...
    [
        ...
        'featured_image' => 'https://i.pinimg.com/736x/e9/70/9d/e9709d52b60764df6d3108f3f7cff704.jpg',
        'category' => [
            'name' => 'Du lịch biển'
        ],
        'author' => [
...
<div class="bg-gray-50">
                ...
                <div class="relative bg-white rounded-lg max-w-4xl w-full">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="comments-list">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <div class="flex-1 bg-gray-100 rounded-lg p-3">
                                        ...
                                        <p class="text-sm text-gray-600">Bài viết rất hay!</p>
                            ...
                            <!-- Comment Form -->
                            @auth
                            <form class="comment-form flex items-center space-x-3 mt-6"
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-2xl font-bold mb-2 font-roboto">Lastest Posts</h2>
                ...
                <div class="min-h-screen px-4 flex items-center justify-center">
                    ...
                    <div class="relative bg-white rounded-lg max-w-4xl w-full">
                        ...
                        <div class="p-6">
                            ...
                            <!-- Comments Section -->
                            <div class="space-y-4 post-comments">
                                <h3 class="font-semibold">Bình luận gần đây</h3>
                                <div class="comments-list">
                                    <!-- Sample Comments -->
                                    <div class="flex space-x-3">
...
document.addEventListener('DOMContentLoaded', function() {
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-grow">
                        <div class="bg-gray-100 p-3 rounded-lg">
                            <div class="font-medium">${comment.user.full_name}</div>
                            <p class="text-gray-800">${comment.content}</p>
                        </div>
                        <div class="mt-2 text-sm text-gray-500 flex items-center space-x-4">
                            <span>${date}</span>
                            <button class="reply-button hover:text-blue-600" 
    ...
    if (commentForm) {
        commentForm.addEventListener('submit', async (e) => {
            ...
            const postId = e.target.querySelector('input[name="post_id"]').value;
    ...
    // Xử lý nút reply
    const handleReplyButton = (button) => {
            ...
            replyFormContainer.innerHTML = `
                <form class="reply-form-content">
                    ...
                    <div class="mt-2 flex justify-end space-x-2">
                        <button type="button" 
                                class="cancel-reply px-4 py-2 text-gray-600 hover:text-gray-800">
                            Hủy
                        </button>
                        <button type="submit" 
